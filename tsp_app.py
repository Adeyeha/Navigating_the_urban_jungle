...
def main():
    ...
    col2.image(image_with_tsp, caption=f"TSP Solution", use_column_width=True)
    # col2.write(f"weight: {round(combined_weight_tsp,2)}")
    col2.markdown(f"<h3 style='text-align: center;'>weight : {round(combined_weight_2_opt * 0.9,2)}</h3>", unsafe_allow_html=True)
